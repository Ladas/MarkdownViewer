...
public final class ClaudeCLIRunner: @unchecked Sendable {
    ...
    static func parseEnvironment(from output: String) -> [String: String] {
    ...
    private static let shellEnvironment: [String: String] = {
        ...
        let parsed = parseEnvironment(from: output)
        return parsed.isEmpty ? ProcessInfo.processInfo.environment : parsed
    }()
